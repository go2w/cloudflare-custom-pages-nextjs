...
export const ErrorBox = ({ type, code, box, icon, networkStatus }: ErrorPageConfig) => {
  ...
  useEffect(() => {
    ...
    const errorBoxId =
      num >= 1000 ? "cf-error-1000s-box"
      : num >= 500 ? "cf-error-500s-box"
      : null;
